...
document.title = '710.Chess(v1.0) | Created by Taz';
...
function newGame() {
  ...
  engine.drawBoard();
  engine.updateBoard();
  document.getElementById('pgn').value = "Hello! I am Taz. I want to play Chess with you. Let's play Chess...";
  repetitions = 0;
...
function think() {
  ...
  if (repetitions == 3) {
    ...
    gameResult = engine.getSide() == 0 ? '0-1 Mate. Taz Win!!!' : '1-0 Mate. You Win!!!';
    updatePgn();
    return;
  } else if (guiScore == 'M1') {
    gameResult = engine.getSide() == 0 ? '1-0 Mate. You Win!!!' : '0-1 Mate. Taz Win!!!';
...
function updatePgn() {
  ...
  if (gameResult == '1-0 Mate. You Win!!!' || gameResult == '0-1 Mate. Taz Win!!!') {
